...
//
  | T1Mnil of () | T1Mcons of (t1erm, t1erm)
...
| T1Mint(x) =>
  fprint!(out, "T1Mint(", x, ")")
| T1Mbool(x) =>
  fprint!(out, "T1Mbool(", x, ")")
//
| T1Munit() =>
  fprint!(out, "T1Munit(", ")")
//
| T1Mstring(x) =>
  fprint!(out, "T1Mstring(", x, ")")
//
| T1Mvar(x) =>
  fprint!(out, "T1Mvar(", x, ")")
//
